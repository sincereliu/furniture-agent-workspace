...
其余阶段代码在所属 `domain/skills/{design-intent,layout-plan,panel-plan,manufacturing-plan,feature-tree,delivery-report}/scripts/`。CLI/API/Agent 均经 `FurnitureOrchestrator`；阶段包不得另建状态机或流水线。

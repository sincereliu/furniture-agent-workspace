...
class RoomSceneApiTests(unittest.TestCase):
    ...
    def test_save_then_load_round_trip(self) -> None:
        saved = asyncio.run(server.save_room_scene(save_request("demo")))
    ...
    def test_save_generates_id_when_absent(self) -> None:
        saved = asyncio.run(server.save_room_scene(save_request("")))
    ...
    def test_list_room_scenes(self) -> None:
        asyncio.run(server.save_room_scene(save_request("b")))
        asyncio.run(server.save_room_scene(save_request("a")))
